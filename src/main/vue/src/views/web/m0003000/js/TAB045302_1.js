...
const grid = {
  ...
  fields: [
   ...
   // { fieldName: 'model', dataType: ValueType.TEXT },
    ...
    { fieldName: 'samplePack', dataType: ValueType.BOOLEAN },
  ...
  columns: [
    ...
    { name: 'runId', fieldName: 'runId', width: '120', mergeRule: { criteria: "value['의뢰일자'] + '|' + value['의뢰차수'] + value"}, header: { text: '샘플요청\nRUN NO', styleName:'multiline-header' }, autoFilter: true, styleName: 'tl' },
    { name: 'samplePack', fieldName: 'samplePack', width: '50', header: { text: '샘플인계\nPACK', styleName:'multiline-header'}, autoFilter: true, checked:true, renderer: {type: 'check'}, styleName: 'tc' },
    { name: 'packNo', fieldName: 'packNo', width: '220', header: { text: 'Pack No.(요청)' }, autoFilter: true, styleName: 'tl' },
