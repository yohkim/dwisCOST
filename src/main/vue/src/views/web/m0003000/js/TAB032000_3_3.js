...
const grid = {
	...
	columns: [
		{ name: "fCstno", fieldName: "fCstno", header: { text: "투입카세트" }, renderer: { showTooltip: true }, width: 150, styleName: "tl" },
		...
		{ name: "tCstno", fieldName: "tCstno", header: { text: "출고카세트" }, renderer: { showTooltip: true }, width: 150, styleName: "tl", mergeRule: "value" },
