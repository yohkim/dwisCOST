...
const grid = {
  ...
  columns: [
    { name: '구분', fieldName: '구분', width: '60', header: { text: '구분' }, autoFilter: true, styleName: 'tl' },
    {
      ...
      autoFilter: true,
      mergeRule: {
        criteria: "values['originNo'] + value",
      },
      styleName: 'tl',
    },
    { name: 'runCell', fieldName: 'runCell', width: '50', header: { text: 'Cell수' }, autoFilter: true, numberFormat: '#,###.###', styleName: 'tr',
      footer: {
        text: "0",
        expression: "sum",
        numberFormat: "#,##0",
    ...
    { name: 'originNo', fieldName: 'originNo', width: '170', header: { text: 'ORIGIN NO' }, mergeRule: { criteria: "values['originNo'] + value" }, autoFilter: true, styleName: 'tl' },
    { name: 'packNo', fieldName: 'packNo', width: '220', header: { text: 'PACK NO' }, autoFilter: true, styleName: 'tl' },
    { name: 'boxNo', fieldName: 'boxNo', width: '220', header: { text: 'BOX NO' }, autoFilter: true, styleName: 'tl' },
    { name: 'cell수량', fieldName: 'cell수량', width: '50', header: { text: '수량' },  mergeRule: { criteria: "values['originNo'] + value" }, autoFilter: true, numberFormat: '#,###.###', styleName: 'tr',
      footer: {
        text: "0",
        expression: "sum",
        numberFormat: "#,##0",
    ...
    { name: '작업일자', fieldName: '작업일자', width: '130', header: { text: '작업일자' }, autoFilter: true, styleName: 'tl', displayCallback: rgDisplayDateTime1 },
    { name: '작업자', fieldName: '작업자', width: '60', header: { text: '작업자' }, autoFilter: true, styleName: 'tl' },
    { name: '설비', fieldName: '설비', width: '50', header: { text: 'LINE' }, autoFilter: true, styleName: 'tl' },
    { name: 'shift', fieldName: 'shift', width: '50', header: { text: 'Shift' }, autoFilter: true, styleName: 'tl' },
    { name: 'svi', fieldName: 'svi', width: '50', header: { text: 'SVI' }, autoFilter: true, styleName: 'tl' },
    { name: 'agb', fieldName: 'agb', width: '50', header: { text: 'AGB' }, autoFilter: true, styleName: 'tl' },
    { name: 'pfl', fieldName: 'pfl', width: '50', header: { text: 'PFL' }, autoFilter: true, styleName: 'tl' },
  ...
  layout: [
    '구분',
    {
      ...
      items: ['runNo', 'runCell','originNo', 'cell수량', 'packNo', 'boxNo'],
      header: { text: '제품현황' },
    },
    {
      name: '이물제거작업현황',
