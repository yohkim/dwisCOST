...
const grid = {
  ...
  columns: [
    { name: '구분', fieldName: '구분', width: '60', header: { text: '구분' }, autoFilter: true, styleName: 'tl' },
    {
      name: 'runNo',
      fieldName: 'runNo',
      width: '130',
    ...
    { name: 'packNo', fieldName: 'packNo', width: '250', header: { text: 'PACK NO' }, autoFilter: true, styleName: 'tl' },
    { name: 'boxNo', fieldName: 'boxNo', width: '250', header: { text: 'BOX NO' }, autoFilter: true, styleName: 'tl' },
    { name: 'cell수량', fieldName: 'cell수량', width: '50', header: { text: '수량' }, autoFilter: true, numberFormat: '#,###.###',
      footer: {
        text: "0",
        expression: "sum",
        numberFormat: "#,##0",
    ...
    { name: '작업일자', fieldName: '작업일자', width: '85', header: { text: '작업일자' }, autoFilter: true, styleName: 'tl', displayCallback: rgDisplayDateTime1 },
    { name: '작업자', fieldName: '작업자', width: '40', header: { text: '작업자' }, autoFilter: true, styleName: 'tl' },
    { name: '설비', fieldName: '설비', width: '30', header: { text: 'LINE' }, autoFilter: true, styleName: 'tl' },
    { name: 'shift', fieldName: 'shift', width: '30', header: { text: 'Shift' }, autoFilter: true, styleName: 'tl' },
    { name: 'svi', fieldName: 'svi', width: '40', header: { text: 'SVI' }, autoFilter: true, styleName: 'tl' },
    { name: 'agb', fieldName: 'agb', width: '40', header: { text: 'AGB' }, autoFilter: true, styleName: 'tl' },
    { name: 'pfl', fieldName: 'pfl', width: '40', header: { text: 'PFL' }, autoFilter: true, styleName: 'tl' },
    { name: '처리시각', fieldName: '처리시각', width: '85', header: { text: '처리시각' }, autoFilter: true, displayCallback: rgDisplayDateTime1 },
    { name: '발행자', fieldName: '발행자', width: '60', header: { text: '담당자' }, autoFilter: true },
    {
      name: '발행자서명',
      fieldName: '발행자서명',
      width: '30',
  ...
  layout: [
    '구분',
    {
      ...
      items: ['runNo', 'packNo', 'boxNo', 'cell수량'],
      header: { text: '제품현황' },
    },
    {
      name: '이물제거작업현황',
