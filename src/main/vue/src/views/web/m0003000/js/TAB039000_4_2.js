...
const grid = {
	...
	fields: [
		...
		{ fieldName: '불량', dataType: ValueType.TEXT },				
	...
	columns: [
		...
		{ name: "result", fieldName: "result", header: { text: "양품" }, width: 100, renderer: { showTooltip: true }, styleName: "tl", autoFilter: true },
		{ name: "불량", fieldName: "불량", header: { text: "불량" }, width: 100, renderer: { showTooltip: true }, styleName: "tl" },
		{ name: "특이사항", fieldName: "특이사항", header: { text: "불량사유" }, width: 250, renderer: { showTooltip: true }, styleName: "tl" },
	...
	layout: [
		"작업일자","설비약명","근무조","작업자","cellId","startTime","endTime","차수","result"		
	],
}
