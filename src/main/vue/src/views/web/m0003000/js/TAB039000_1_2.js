...
const grid = {
	...
	fields: [
		...
		{ fieldName: 'bin1', dataType: ValueType.NUMBER },
		{ fieldName: 'bin2', dataType: ValueType.NUMBER },
	...
	columns: [
		...
		{ name: "검사수량", fieldName: "검사수량", header: { text: "검사수량" }, editable: false, numberFormat: "#,##0", renderer: { showTooltip: true }, styleName: "tr" },
		{ name: "불량수량", fieldName: "불량수량", header: { text: "불량수량" }, editable: false, numberFormat: "#,##0", renderer: { showTooltip: true }, styleName: "tr" },
		...
		{ name: "bin1", fieldName: "bin1", header: { text: "BIN1" }, editable: false, numberFormat: "#,##0", renderer: { showTooltip: true }, styleName: "tr" },
		{ name: "bin2", fieldName: "bin2", header: { text: "BIN2" }, editable: false, numberFormat: "#,##0", renderer: { showTooltip: true }, styleName: "tr" },
	...
	layout: ["차수",
		...
		{
			name: "검사현황",
			items: ["투입수량", "검사수량", "중복", "양품수량", "불량수량", "bin1", "bin2", "out"],
			header: { text: "검사현황" },
		},
	],
}
