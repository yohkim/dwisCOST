...
const { rgDisplayDate, rgDisplayTime, getTimeDifference } = require('@/utils/dateUtils');
...
const valueCallback2 = function (ds, index, fieldName, fields, values) {
	return getTimeDifference(values[fields.indexOf('작업시작')], values[fields.indexOf('시작시각')], values[fields.indexOf('작업종료')], values[fields.indexOf('종료시각')]);
}
...
const grid = {
	...
	fields: [
		...
		{ fieldName: '세정차수', dataType: ValueType.TEXT },
		...
		{ fieldName: '소요시간', dataType: ValueType.TEXT,
	...
	columns: [
		...
		{ name: "tCstno", fieldName: "tCstno", header: { text: "CST No" }, editable: false, renderer: { showTooltip: true }, styleName: "tl" },
		//{ name: "세정차수", fieldName: "세정차수", header: { text: "차수" }, editable: false, renderer: { showTooltip: true }, styleName: "tr" },
		{ name: "작업자", fieldName: "작업자", header: { text: "작업자" }, editable: false, renderer: { showTooltip: true }, styleName: "tl" },
		{ name: "작업조", fieldName: "작업조", header: { text: "근무조" }, editable: false, renderer: { showTooltip: true }, styleName: "tl" },
		...
		{ name: "소요시간", fieldName: "소요시간", header: { text: "소요시간" }, editable: false, renderer: { showTooltip: true }, styleName: "tr" },
		{ name: "설비약명", fieldName: "설비약명", header: { text: "M/C", visible: false }, editable: false, renderer: { showTooltip: true }, styleName: "tl" },
		...
		{ name: "특이사항", fieldName: "특이사항", header: { text: "공정 특이사항" }, editable: false, renderer: { showTooltip: true }, styleName: "tl" },
	],
