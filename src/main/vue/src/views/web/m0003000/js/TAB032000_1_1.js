...
const grid = {
	...
	fields: [
		{ fieldName: '책임자', dataType: ValueType.TEXT },
		{ fieldName: '선임자', dataType: ValueType.TEXT },
	...
	columns: [
		...
		{ name: "책임자", fieldName: "책임자", header: { text: "책임자" }, editable: false, renderer: { showTooltip: true }, styleName: "tl" },
		{ name: "선임자", fieldName: "선임자", header: { text: "선임자" }, editable: false, renderer: { showTooltip: true }, styleName: "tl" },
		...
		{ name: "투입수량", fieldName: "투입수량", header: { text: "IN수량" }, editable: false, renderer: { showTooltip: true }, styleName: "tr" },
