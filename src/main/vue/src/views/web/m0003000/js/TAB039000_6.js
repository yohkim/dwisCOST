...
const grid = {
	...
	fields: [
		...
		{ fieldName: '맵핑유무', dataType: ValueType.TEXT },
	...
	columns: [
		...
		{ name: "scrap", fieldName: "scrap", header: { text: "불량사유" }, width: 80, renderer: { showTooltip: true }, styleName: "tl", autoFilter:true },
		{ name: "맵핑유무", fieldName: "맵핑유무", header: { text: "맵핑" }, width: 80,
			renderer:{
				type:"html",
				callback: function(grid, cell, w, h) {
					const str = '<button type="button" class="btn_error">맵핑</button>';
					return str;
				}
			},
		},
	...
	layout: [
		{
			...
			items: [
				...
				{column: "scrap", groupShowMode:"always"},
				...
				{column: "맵핑유무", groupShowMode:"always"},
			],
		},
	],
}
