...
const grid = {
  ...
  columns: [
    ...
    { name: 'packno', fieldName: 'packno', width: '230', header: { text: 'Pack No.' }, autoFilter: true, editable: true, styleName: 'edit tl' },
    ...
    { name: 'utm호기', fieldName: 'utm호기', width: '100', header: { text: 'UTM호기' }, autoFilter: true, visible: false, editable: false, styleName: 'tl' },
    ...
    { name: '판정1', fieldName: '판정1', width: '80', header: { text: '판정1' }, autoFilter: true, editable: false, styleName: 'tl' },
    { name: '판정2', fieldName: '판정2', width: '80', header: { text: '판정2' }, autoFilter: true, editable: false, styleName: 'tl' },
    { name: '특이사항', fieldName: '특이사항', width: '120', header: { text: '특이사항' }, autoFilter: true, editable: false, styleName: 'tl' },
    { name: '검사결과확인', fieldName: '검사결과확인', width: '100', header: { text: '확인자' }, autoFilter: true, editable: false, styleName: 'tl' },
    { name: '검사결과확인일시', fieldName: '검사결과확인일시', width: '140', header: { text: '검사결과 확인일시' }, autoFilter: true, editable: false, styleName: 'tl', displayCallback: rgDisplayDateTime1 },
  ],
  layout: [
    {
      name: '제조',
