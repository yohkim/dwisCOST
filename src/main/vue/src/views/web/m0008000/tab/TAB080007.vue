...
export default {
  ...
  methods: {
    ...
    initializeGrid() {
      this.grid = _.cloneDeep(require(`@web/m0008000/js/TAB080007.js`));
    },
    ...
    resetGrid() {
      ...
      if (this.srchInfo.menu3Item.value == '80') {
    ...
    getAddList() {
      ...
      this.$nextTick(async () => {
        ...
        if (this.srchInfo.menu3Item.value == '80' && _.isEmpty(this.params.subItemValue)) {
        ...
        let params = {
          ...
          item: !_.isEmpty(this.srchInfo.menu3Item) ? this.srchInfo.menu3Item.value : '',
        ...
        let searchParam = [
          {
            menuId: this.menuId,
            queryId: this.srchInfo.menu3Item.value != '80' ? 'M0008003_Get1' : 'M0008003_Get2',
            queryParams: params,
            callback: (data) => {
    ...
    addGridRow(item) {
      if (_.isEmpty(item['runNo'])) {
        const message = `QR code에 해당하는 Run No.정보가 없습니다.`;
        this.$toast('info', message);
        return;
      }
    ...
    async saveData() {
      ...
      let param = {
        menuId: this.menuId,
        delete: [{ queryId: 'M0008003_Delete1', data: saveData.delete }],
        insert: [{ queryId: 'M0008003_Insert1', data: saveData.insert }],
    ...
    async inspectionData() {
      ...
      let param = {
        menuId: this.menuId,
        update: [{ queryId: 'M0008003_U_Inspection1', data: updated }],
      };
