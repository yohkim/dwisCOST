...
export default {
  ...
  methods: {
    ...
    initializeGrid() {
      this.grid = _.cloneDeep(require(`@web/m0008000/js/TAB080001.js`));
    },
    ...
    resetGrid() {
      ...
      if (this.srchInfo.menu1Item.value == '80') {
    ...
    getAddList() {
      ...
      this.$nextTick(async () => {
        ...
        if (this.srchInfo.menu1Item.value == '80' && _.isEmpty(this.params.subItemValue)) {
        ...
        let params = {
          ...
          item: !_.isEmpty(this.srchInfo.menu1Item) ? this.srchInfo.menu1Item.value : '',
        ...
        let searchParam = [
          {
            menuId: this.menuId,
            queryId: this.srchInfo.menu1Item.value != '80' ? 'M0008001_Get1' : 'M0008001_Get2',
            queryParams: params,
            callback: (data) => {
    ...
    async saveData() {
      ...
      let param = {
        menuId: this.menuId,
        delete: [{ queryId: 'M0008001_Delete1', data: saveData.delete }],
        insert: [{ queryId: 'M0008001_Insert1', data: saveData.insert }],
    ...
    async inspectionData() {
      ...
      let param = {
        menuId: this.menuId,
        update: [{ queryId: 'M0008001_U_Inspection1', data: updated }],
      };
