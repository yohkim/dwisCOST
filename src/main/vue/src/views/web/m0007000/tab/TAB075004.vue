  ...
  <div>
    <div class="search_box">
      <b-row class="search_area">
        ...
        <b-col cols="2">
          <div class="form-floating">
            <input autocomplete="off" type="text" class="form-control label-60" id="floating" placeholder="Status" :disabled="true" v-model="params.status" ref="statusField" />
...
export default {
  ...
  mounted() {
    this.$eventBus.on('TAB075004MenuMove', this.tabMove);
  },
  beforeUnmount() {
    this.$eventBus.off('TAB075004MenuMove');
  },
  methods: {
    initialize() {
    ...
    initializeGrid() {
      this.cstGrid = _.cloneDeep(require(`@web/m0007000/js/TAB075002.js`));
    },
    tabMove(data) {
      this.$nextTick(() => {
    ...
    async excelClick() {
      ...
      const fileName = `CassetteHistory_${yyyymmdd}_${hours}${minutes}${seconds}.xlsx`;
