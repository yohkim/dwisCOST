...
const grid = {
  ...
  columns: [
    ...
    { name: '반입일자', fieldName: '반입일자', width: '80', header: { text: '반입일자' }, autoFilter: true, styleName: 'tl', displayCallback: rgDisplayDate },
    { name: '반입시간', fieldName: '반입시간', width: '80', header: { text: '반입시간' }, autoFilter: true, styleName: 'tl', displayCallback: rgDisplayTime },
    { name: '반입자', fieldName: '반입자', width: '80', header: { text: '반입자' }, autoFilter: true, styleName: 'tl' },
