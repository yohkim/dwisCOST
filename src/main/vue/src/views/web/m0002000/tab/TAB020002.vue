...
import gridField from "@web/m0002000/js/TAB020002.js";
...
export default {
  ...
  methods: {
    ...
    async excelBtnClick() {
      ...
      const fileName = `설비현황${yyyymmdd}_${hours}${minutes}${seconds}.xlsx`;
        ...
        async (confirm) => {
          if (confirm) {
            ...
            console.log(saveData);
              let param = {
                menuId:'m0006011',
                delete: [{queryId:'deleteData1', data:saveData.delete}],
