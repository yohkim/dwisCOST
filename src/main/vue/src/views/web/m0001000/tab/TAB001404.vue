...
import gridField from '@web/m0001000/js/TAB001404.js';

const URI_PREFIX = '/api/m0001000/m0001004/TAB001404';
...
export default {
	...
	methods: {
        ...
        async getSelectOptions(){
			...
			let searchParam = { menuId:'M0001004', queryId:'selectMaxStockDate', target:stockDate }
		...
		async getDataList(){  
			...
			let param = {menuId:'M0001004',queryId:'selectSubMatFilmMonthReport', queryParams:params, target: this.gridRows};
        ...
        excelBtnClick(){
			...
			const fileName = `필름_${this.searchStockMonth}월_재고현황_${yyyymmdd}_${hours}${minutes}${seconds}.xlsx`;
