...
import gridField from '@web/m0001000/js/TAB001402.js';

const URI_PREFIX = '/api/m0001000/m0001002/TAB001402';
...
export default {
	...
	methods: {
        ...
        async getSelectOptions(){
			...
			let searchParam = { menuId:'M0001002', queryId:'selectMaxStockDate', target:stockDate }
		...
		async getDataList(){  
			...
			let param = {menuId:'M0001002',queryId:'selectSubMatResinMonthReport', queryParams:params, target: this.gridRows};
        ...
        excelBtnClick(){
			...
			const fileName = `레진_${this.searchStockMonth}월_재고현황_${yyyymmdd}_${hours}${minutes}${seconds}.xlsx`;
