...
import gridField from '@web/m0001000/js/TAB001303.js';

const URI_PREFIX = '/api/m0001000/m0001003/TAB001303';
...
export default {
	...
	mounted() {
		...
		this.$eventBus.on("TAB001303MenuMove", this.menuMove);		
	},
	beforeUnmount() {
		this.$eventBus.off("TAB001303MenuMove");
	},
	...
	methods: {
        ...
        async getSelectOptions(){
			...
			let searchParam = [
				...
				{ menuId:'M0001003', queryId:'selectMaxStockDate', target:stockDate }
            ];
        ...
        async getDataList(){
			...
			let param = {menuId:'M0001003',queryId:'selectSubMatToolIdStock', queryParams:params, target: this.gridRows};
        ...
        async processBarcode(){
			...
			if ( this.checkValidBarcodeData() ) {
                ...
                let param = {menuId:'M0001003',queryId:'selectSubMatToolIdStock', queryParams:params, target: matInfo};
        ...
        async excelBtnClick(){
			...
			const fileName = `Tool_${yyyymmdd}일_재고현황_${hours}${minutes}${seconds}.xlsx`;			
