...
import gridField from '@web/m0001000/js/TAB001406.js';

const URI_PREFIX = '/api/m0001000/m0001006/TAB001406';
...
export default {
	...
	methods: {
        ...
        async getSelectOptions(){
			...
			let searchParam = { menuId:'M0001006', queryId:'selectMaxStockDate', target:stockDate }
		...
		async getDataList(){  
			...
			let param = {menuId:'M0001006',queryId:'selectSubMatChemicalMonthReport', queryParams:params, target: this.gridRows};
        ...
        excelBtnClick(){
			...
			const fileName = `약액_${this.searchStockMonth}월_재고현황_${yyyymmdd}_${hours}${minutes}${seconds}.xlsx`;
