...
import gridField from '@web/m0001000/js/TAB001409.js';

const URI_PREFIX = '/api/m0001000/m0001009/TAB001409';
...
export default {
	...
	methods: {
        ...
        async getSelectOptions(){
			...
			let searchParam = { menuId:'M0001009', queryId:'selectMaxStockDate', target:stockDate }
		...
		async getDataList(){  
			...
			let param = {menuId:'M0001009',queryId:'selectSubMatEtcMonthReport', queryParams:params, target: this.gridRows};
        ...
        excelBtnClick(){
			...
			const fileName = `포장재_${this.searchStockMonth}월_재고현황_${yyyymmdd}_${hours}${minutes}${seconds}.xlsx`;
