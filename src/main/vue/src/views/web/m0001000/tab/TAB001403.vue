...
import gridField from '@web/m0001000/js/TAB001403.js';

const URI_PREFIX = '/api/m0001000/m0001003/TAB001403';
...
export default {
	...
	methods: {
        ...
        async getSelectOptions(){
			...
			let searchParam = { menuId:'M0001003', queryId:'selectMaxStockDate', target:stockDate }
		...
		async getDataList(){  
			...
			let param = {menuId:'M0001003',queryId:'selectSubMatToolMonthReport', queryParams:params, target: this.gridRows};
        ...
        excelBtnClick(){
			...
			const fileName = `Tool_${this.searchStockMonth}월_재고현황_${yyyymmdd}_${hours}${minutes}${seconds}.xlsx`;
