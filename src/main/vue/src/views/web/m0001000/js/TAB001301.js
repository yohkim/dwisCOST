...
const grid = {
	...
	fields: [
		...
		{ fieldName: 'goodQty'			,dataType: ValueType.NUMBER },
	...
	columns: [
		...
		{ name:'useCategoryName'	,fieldName:'useCategoryName'	,width:'60', header:{text:'투입\n구분' }, editable:false, autoFilter:true},
		{ name:'glassMaterial'		,fieldName:'glassMaterial'		,width:'60', header:{text:'원장\n사양' }, editable:false, autoFilter:true},
		{ name:'glassThickness'		,fieldName:'glassThickness'		,width:'60', header:{text:'두께' }, editable:false, autoFilter:true},
		...
		{ name:'comments'			,fieldName:'comments'			,width:'400', header:{text:'비고' }, editable:false, autoFilter:true},
	],	
} 
