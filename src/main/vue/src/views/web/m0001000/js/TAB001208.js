...
const grid = {
	...
	columns: [		
		...
		{ name:'outTime'         ,fieldName:'outTime'       ,width: '80'  ,header: { text: '투입\n시간', styleName:'multiline-header'  }, editable: false, autoFilter:true, editor: {mask:{editMask:"00:00"}}, "textFormat": "([0-9]{2})([0-9]{2});$1:$2" },        
		{ name:'materialId'      ,fieldName:'materialId'    ,width: '130' ,header: { text: '자재 ID' }, editable: false, autoFilter:true },        
		{ name:'size'  			 ,fieldName:'size'			,width: '80'  ,header: { text: 'Size' }, editable: false, autoFilter:true},
		{ name:'workerName'      ,fieldName:'workerName'    ,width: '80'  ,header: { text: '작업자' }, editable: false, autoFilter:true }, 
		{ name:'useCategory' 	,fieldName:'useCategory'   ,width: '60'  ,header: { text: '투입구분' }, editable: false, autoFilter:true,  lookupDisplay:true, editor: { type:"dropdown", textReadOnly:true } },
		{ name:'equipNm'         ,fieldName:'equipNm'       ,width: '120' ,header: { text: '투입설비' }, editable: false, autoFilter:true },        
        ...
        { name:'outQty'          ,fieldName:'outQty'        ,width: '60'  ,header: { text: '투입수량' }, editable: false, autoFilter:true, numberFormat: '#,##0', styleName:'tr', footer:{expression:"sum", numberFormat: "#,##0", styleName:"sum-footer1"}},		
        { name:'errorWorkQty'    ,fieldName:'errorWorkQty'  ,width: '60'  ,header: { text: '작업불량' }, editable: false, autoFilter:true, numberFormat: '#,##0', styleName:'tr', footer:{expression:"sum", numberFormat: "#,##0", styleName:"sum-footer3"}  },
        { name:'errorMatQty'     ,fieldName:'errorMatQty'   ,width: '60'  ,header: { text: '원자재\n불량', styleName: 'multiline-header' }, editable: false, autoFilter:true, numberFormat: '#,##0', styleName:'tr', footer:{expression:"sum", numberFormat: "#,##0", styleName:"sum-footer4"}  },		
