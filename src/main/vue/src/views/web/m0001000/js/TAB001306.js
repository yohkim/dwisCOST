...
const grid = {
	...
	columns: [
		...
		{ name:'chemicalName'		,fieldName:'chemicalName'		,width:'120', header:{text:'품명' }, editable:false, autoFilter:true},
		...
		{ name:'diffQty'			,fieldName:'diffQty'			,width:'60', header:{text:'차이\n수량', styleName:'multiline-header' }, editable:false, autoFilter:true, autoFilter:true,numberFormat: '#,##0', styleName:"tr"},
