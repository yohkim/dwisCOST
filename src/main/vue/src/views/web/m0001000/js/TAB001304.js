...
const grid = {
	...
	columns: [
		...
		{ name:'materialId'			,fieldName:'materialId'			,width:'250', header:{text:'자재ID' }, editable:false, autoFilter:true},
		{ name:'prodCategoryName'	,fieldName:'prodCategoryName'	,width:'40', header:{text:'제품' }, editable:false, autoFilter:true},
		{ name:'modelCode'			,fieldName:'modelCode'			,width:'50', header:{text:'모델' }, editable:false, autoFilter:true},
		{ name:'filmName'			,fieldName:'filmName'			,width:'80', header:{text:'필름' }, editable:false, autoFilter:true},
