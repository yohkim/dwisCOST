...
const grid = {
	...
	fields: [
		...
		{ fieldName: 'storeDays'  	    ,dataType: ValueType.TEXT },
	...
	columns: [
		...
		{ name:'materialId'			,fieldName:'materialId'			,width:'400', header:{text:'자재ID' }, editable:false, autoFilter:true},
		...
		{ name:'storeDays'  	    ,fieldName:'storeDays'  	    ,width:'60', header:{text:'상온보관\n경과일', styleName:"multiline-header" }, editable:false, autoFilter:true},
		...
		{ name:'comments'			,fieldName:'comments'			,width:'150', header:{text:'비고' }, editable:false, autoFilter:true},
	],	
} 
