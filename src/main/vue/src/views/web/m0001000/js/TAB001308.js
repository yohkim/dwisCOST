...
const grid = {
	...
	fields: [
		...
		{ fieldName: 'sub_mat_type_code',dataType: ValueType.TEXT },	
	...
	columns: [
		...
		{ name:'materialId'			,fieldName:'materialId'			,width:'150', header:{text:'자재ID' }, editable:false, autoFilter:true},		
		{ name:'size'				,fieldName:'size'				,width:'120', header:{text:'Size' }, editable:false, autoFilter:true},
		...
		{ name:'errorWorkQty'		,fieldName:'errorWorkQty'		,width:'60', header:{text:'작업\n불량수량', styleName:"multiline-header"  }, editable:false, autoFilter:true,numberFormat: '#,##0', styleName:"tr"},
		...
		{ name:'comments'			,fieldName:'comments'			,width:'250', header:{text:'비고' }, editable:false, autoFilter:true},
	],	
}
