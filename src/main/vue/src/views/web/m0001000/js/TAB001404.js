...
const grid = {
	...
	columns: [
		{ name:'prodCategoryName',fieldName:'prodCategoryName'	,width:'60', header:{text:'제품' }, editable:false, mergeRule: "value", autoFilter:true},
		{ name:'modelCode'		,fieldName:'modelCode'		,width:'60', header:{text:'모델' }, editable:false, mergeRule: "value", autoFilter:true},
		{ name:'filmName'		,fieldName:'filmName'		,width:'100', header:{text:'필름' }, editable:false, mergeRule: "values['modelCode'] + value", autoFilter:true},
