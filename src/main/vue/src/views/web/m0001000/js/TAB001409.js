...
const grid = {
	...
	columns: [
		{ name:'matCategoryName',fieldName:'matCategoryName',width:'100', header:{text:'자재분류' }, editable:false, mergeRule: "value", autoFilter:true},
		{ name:'matTypeName'	,fieldName:'matTypeName',width:'100', header:{text:'품명' }, editable:false, mergeRule: "value", mergeRule: "values['matCategoryName'] + value", autoFilter:true},
