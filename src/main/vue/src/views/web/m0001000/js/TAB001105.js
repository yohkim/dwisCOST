...
const grid = {
	...
	columns: [
		...
		{ name: 'subMatTypeCode'	,fieldName:'subMatTypeCode'	,width: '100', header: { text: '자재종류' }, editable: false, autoFilter:true,  lookupDisplay:true, editor: { type:"dropdown", textReadOnly:true },},		
		{ name: 'trayCode'			,fieldName:'trayCode'		,width: '120', header: { text: 'TrayCode' }, editable: false, autoFilter:true, autoFilter:true },
		{ name: 'model'				,fieldName:'model'			,width: '150', header: { text: '모델' }, editable: false, autoFilter:true, autoFilter:true },
