...
const grid = {
	...
	columns: [
		...
		{ name:'subMatTypeName'		,fieldName:'subMatTypeName'		,width:'80', header:{text:'자재종류' }, editable:false, autoFilter:true},
		...
		{ name:'errorWorkQty'		,fieldName:'errorWorkQty'		,width:'60', header:{text:'작업불량\n수량', styleName:"multiline-header"  }, editable:false, autoFilter:true,numberFormat: '#,##0', styleName:"tr"},
