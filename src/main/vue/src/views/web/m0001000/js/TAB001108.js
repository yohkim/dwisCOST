...
const grid = {
	...
	columns: [		
		...
		{ name: 'subMatTypeCode'	,fieldName:'subMatTypeCode'	,width: '120', header: { text: 'Size' }, editable: false, autoFilter:true, lookupDisplay:true, editor: { type:"dropdown", textReadOnly:true } },
