...
const grid = {
	...
	columns: [
		{ name:'outNo'			 ,fieldName:'outNo'			,width: '170', header: { text: '투입번호' }, editable: false, autoFilter:true },
        ...
        { name:'comments'        ,fieldName:'comments'      ,width: '300' ,header: { text: '비고' }, editable: false, autoFilter:true, styleName:'tl' },
	],	
} 
