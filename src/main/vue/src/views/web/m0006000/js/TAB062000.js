...
const grid = {
	...
	columns: [
		...
		{ name: 'deptCode', fieldName: 'deptCode', width: '150', header: { text: '부서 CODE' }, autoFilter:true},
		...
		{ name: 'password', fieldName: 'password', width: '150', header: { text: 'PASSWORD' } },
		{
			name: 'utg', fieldName: 'utg', width: '120', header: { text: 'UTG' }, editable: false,
			renderer: {
				type: "check",
				editable: true,
				trueValues: "Y",
		...
		{
			name: 'itg', fieldName: 'itg', width: '120', header: { text: 'ITG' }, editable: false,
			renderer: {
				type: "check",
				editable: true,
				trueValues: "Y",
