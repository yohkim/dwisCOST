...
const grid = {
	...
	columns: [
		{ name: 'mboxNo', fieldName: 'mboxNo', width: '100', header: { text: 'M-BOX NO' },styleName:"edit", editable:true},		
		{ name: 'befRunno', fieldName: 'befRunno', width: '100', header: { text: 'Bef-RUN NO' },styleName:"edit", editable:true},		
		...
		{ name: 'f수량', fieldName: 'f수량', width: '60', header: { text: '입고수량' },styleName:"edit tr",editable:true, numberFormat: "#,##0", footer: {expression: "sum"}},
		{ name: 't수량', fieldName: 't수량', width: '60', header: { text: '양품수량' },styleName:"edit tr",editable:true, numberFormat: "#,##0", footer: {expression: "sum"}},
