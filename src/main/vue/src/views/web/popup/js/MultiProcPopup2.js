...
const grid = {
	...
	fields: [
		...
		{ fieldName: '시작온도', dataType: ValueType.NUMBER },
		{ fieldName: '종료온도', dataType: ValueType.NUMBER },
		{ fieldName: '전면광량', dataType: ValueType.NUMBER },
		{ fieldName: '후면광량', dataType: ValueType.NUMBER },
	...
	columns: [
		...
		{ name: "shift", fieldName: "shift", header: { text: "근무조" }, editable: false,
			renderer: {
				showTooltip: true,
				type:"html",
		...
		{ name: "수율", fieldName: "수율", header: { text: "수율" }, editable: false, numberFormat: "#,##0.##", width: 70, renderer: { showTooltip: true } },
		{ name: "특기사항", fieldName: "특기사항", header: { text: "Lot-CARD 특이사항 및 작업시 주의사항" }, editable: false, width: 100, renderer: { showTooltip: true }, styleName: "tl" },
		{ name: "불량입력", fieldName: "불량입력", header: { text: "item" }, width: 100,
			renderer:{
				showTooltip: true,
				type:"html",
				callback: function(grid, cell, w, h) {
		...
		{ name: "특이사항", fieldName: "특이사항", header: { text: "특이사항" }, editable: false, width: 100, renderer: { showTooltip: true }, styleName: "tl" },
		{ name: "시작온도", fieldName: "시작온도", header: { text: "시작온도" }, editable: false, numberFormat: "#,##0.##", width: 80, renderer: { showTooltip: true }, styleName: "tl" },
		{ name: "종료온도", fieldName: "종료온도", header: { text: "종료온도" }, editable: false, numberFormat: "#,##0.##", width: 80, renderer: { showTooltip: true }, styleName: "tl" },
		{ name: "전면광량", fieldName: "전면광량", header: { text: "전면광량" }, editable: false, numberFormat: "#,##0", width: 80, renderer: { showTooltip: true }, styleName: "tl" },
		{ name: "후면광량", fieldName: "후면광량", header: { text: "후면광량" }, editable: false, numberFormat: "#,##0", width: 80, renderer: { showTooltip: true }, styleName: "tl" },
	],

	layout: ["lotNo","작업자","shift",
		{
			name: "M/C",
			items: ["설비약명", "chamber"],
			header: { text: "M/C" },
		...
		"특기사항","불량입력","특이사항","시작온도","종료온도","전면광량","후면광량"	
	],
}
