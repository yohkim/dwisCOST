...
const grid = {
	...
	columns: [
		...
		// { name: 'cell', fieldName: 'cell', width: '60', header: { text: 'CELL' } , editable:false, numberFormat: "#,##0"},

		{ name: 'fCstno', fieldName: 'fCstno', width: '80', header: { text: 'F-CST NO' }, editable:false},
		{ name: 'inCstno', fieldName: 'inCstno', width: '80', header: { text: 'IN-CST NO' }, editable:false},
		{ name: 'tCstno', fieldName: 'tCstno', width: '80', header: { text: 'T-CST NO' }, editable:false},

		{ name: 't수량', fieldName: 't수량', width: '80', header: { text: '설비수량' }, editable:false, numberFormat: "#,##0", footer: {expression: "sum"}},
		{ name: 'f수량', fieldName: 'f수량', width: '80', header: { text: '양품수량' },styleName:"edit",editable:true, numberFormat: "#,##0", footer: {expression: "sum"}},
		{ name: '불량예상수량', fieldName: '불량예상수량', width: '80', header: { text: '불량예상수량' }, editable:false, numberFormat: "#,##0", footer: {expression: "sum"}},
	],
