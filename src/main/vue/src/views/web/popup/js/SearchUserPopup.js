...
const grid = {
	...
	columns: [
		{ name: 'deptName', fieldName: 'deptName', width: '200', header: { text: '부서명' } },
		{ name: 'deptCode', fieldName: 'userId', width: '150', header: { text: '부서 CODE' } },
		{ name: 'userName', fieldName: 'userName', width: '200', header: { text: '사용자명' } },
		{ name: 'userId', fieldName: 'userId', width: '150', header: { text: '사용자 ID' } },
		{ name: 'positionName', fieldName: 'positionName', width: '150', header: { text: '직책명' } },
		{ name: 'positionCode', fieldName: 'positionCode', width: '150', header: { text: '직책 CODE' } },
	],
}
