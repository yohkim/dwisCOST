...
export default {
  ...
  methods: {
    ...
    searchClick(){
      ...
      let params = [
        {menuId:'M0003005',queryId:'selectWorkIngByFac1',queryParams:qp, target: this.rows1},
        {menuId:'M0003005',queryId:'selectWorkIngByFac2',queryParams:qp, target: this.rows2},
        {menuId:'M0003005',queryId:'selectWorkIngByFac3',queryParams:qp, target: this.rows3},
      ];
    ...
    excelClick(){
      ...
      const fileName = `설비별_작업중 ${yyyymmdd}_${hours}${minutes}${seconds}.xlsx`;
