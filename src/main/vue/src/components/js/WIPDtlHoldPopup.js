...
const grid = {
  ...
  columns: [
    ...
    { name: '종료시간', fieldName: '종료시간', header: { text: '종료 시간' }, width: '100',autoFilter: false, styleName: "tc"},
    { name: '대기시간', fieldName: '대기시간', header: { text: '대기 시간' }, width: '80',autoFilter: false, styleName: "tc"},
    { name: '상태', fieldName: '상태', header: { text: '상태' }, width: '80',autoFilter: true, styleName: "tc"},
    { name: '특이사항', fieldName: '특이사항', header: { text: '특이사항' }, width: '200',autoFilter: false, styleName: "tl"},
