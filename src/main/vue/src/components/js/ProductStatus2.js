...
const grid = {
	...
	columns: [
		...
		{ name: '층수', fieldName: '층수', width: '80', header: { text: '층수' }, mergeRule:{criteria: "value"} },
		{ name: '공정명', fieldName: '공정명', width: '80', header: { text: '공정' } },
		{ name: 'mc', fieldName: 'mc', width: '80', header: { text: 'No' } },
		{ name: 'line축', fieldName: 'line축', width: '80', header: { text: 'Line(축)' } },
		...
		{ name: 'cell수량', fieldName: 'cell수량', width: '80', header: { text: 'Cell' } },
		{ name: 'block수', fieldName: 'block수', width: '80', header: { text: 'Block' } },
		{ name: 'sheet', fieldName: 'sheet', width: '80', header: { text: 'Sheet' } },
		{ name: '특이사항', fieldName: '특이사항', width: '200', header: { text: '특이사항' }, styleName: "tl" },
		...
		"model","inch",
		{
			...
			items: ["lotNo","공정명",
				...
				},
				{
					name: "Out",
					direction: "horizontal",
					items: ["작업종료","종료시각","cell수량","block수","sheet","특이사항"],
					header:{ text: "Out" }
				}],
			header:{ text: "이전공정" }
		},
