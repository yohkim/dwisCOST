...
const grid = {
  ...
  columns: [
    ...
    { name: 'lotRunNo', fieldName: 'lotRunNo', header: { text: 'LOT RUN NO' }, width: '150',autoFilter: true, styleName: "tc"},
    { name: '제품코드', fieldName: '제품코드', header: { text: '제품코드' }, width: '150',autoFilter: true, styleName: "tl"},
