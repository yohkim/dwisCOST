...
const grid = {
  ...
  fields: [
    { fieldName: 'mboxYymm', dataType: ValueType.TEXT },
  ...
  columns: [
    { name: 'mboxYymm', fieldName: 'mboxYymm', header: { text: 'MBOX YYMM' }, width: '80',autoFilter: true, styleName: "tc"},
    ...
    { name: '등록자', fieldName: '등록자', header: { text: '등록자' }, width: '80',autoFilter: true, styleName: "tc"},
    { name: '승인자', fieldName: '승인자', header: { text: '승인자' }, width: '80',autoFilter: true, styleName: "tc"},
