...
const grid = {
  ...
  columns: [
    ...
    { name: 'runNo', fieldName: 'runNo', width: '150', header: { text: 'RUN_NO' }, autoFilter: true, styleName: 'edit tl', editable: true },
    ...
    { name: 'inCstno', fieldName: 'inCstno', width: '80', header: { text: 'IN_CSTNO' }, autoFilter: true, styleName: 'edit tl', editable: true },
